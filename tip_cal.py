from tkinter import Tk, Button, Label, IntVar,StringVar,Entry,Radiobutton
...
class TipCalculator():
    ...
    def __init__(self):
        ...
        tip_percents = Label(window,text="Tip Percetage",bg = "purple",fg="white")
